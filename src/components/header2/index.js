                ...
                <div className="col-lg-8 d-lg-block d-none">
                    <nav>
                        <ul>
                            ...
                            <li><Link to="/contact" title="">Conact</Link></li>
                        </ul>
                    </nav>
                </div>
