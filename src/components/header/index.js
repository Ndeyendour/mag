            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-4 col-sm-4 col-4">
                        <div className="logo">
                            <Link to="/home" title=""><img src={Logo} alt=""/>m a g</Link>
                        </div>
                    </div>
                    <div className="col-lg-8 d-lg-block d-none">
                        <nav>
                            <ul>
                                <li><Link className="active" to="/home" title="">Accueil</Link>
                                    
                                </li>
                                <li><Link to="/about" title="">À propos</Link></li>
                                <li><Link to="/case" title="">Activités</Link>
                                    {/* <ul>
                                        <li><Link to="/case" title="">Formations</Link></li>
                                        <li><Link to="/case-single" title="">Seminaires</Link></li>
                                        <li><Link to="/case" title="">Incubateur</Link></li>
                                ...
                                {/* <li><Link to="/home" title="">Besoins</Link>
                                    <ul>
